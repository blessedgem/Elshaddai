...
class ExportTable extends \ajumamoro\Job
{
 ...
 public function ExportDatabase()
    {
        file_put_contents("exportDatabase.sh", "ssh cloudera@$virtualhost 'sqoop import --connect 'jdbc:postgresql://$localhost:5432/dummy' --username=postgres --password=gem --target-dir /$dirname --table dummy_table -m 1' &> exportTable.out");
    }
